...
return new class extends Migration {
    public function up()
    {
        Schema::create('th_trxsalesrtr', function (Blueprint $table) {
            $table->id('Trx_Auto');
            ...
            $table->string('trx_status', 30)->nullable();
            ...
            $table->decimal('Trx_BON', 18, 2)->default(0.00);
    ...
    {
        Schema::dropIfExists('th_trxsalesrtr');
    }
};
